            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="intro-message">
                        ...
                        <h3>A place to get some questions answered and some tips learned so you can get the most out of Mailsy.</h3>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h2 class="section-heading">How do I use Mailsy? (The Quickstart Guide)</h2>
                    <p class="lead">
                        ...
                        <ol>
                            ...
                            <li>
                                Fill in the subject and message with content that you can use over and over for a given "campaign".
                            </li>
                            <li>
                                To create a piece of information that you want to customize with each message, use '@@' to denote this. You can name a field with any upper- or lower-case letter/number combination.
                                These names can't include special characters (!, @, %, ^, etc) or spaces, however.
                            </li>
                            <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <hr class="section-heading-spacer">
                    <div class="clearfix"></div>
                    <h2 class="section-heading">Will the recipients know that I used Mailsy to send them an email?</h2>
                    <p class="lead">
