...
@section('content')
	...
	<p class='lead'>We'll need to save your company's email settings to your profile so we can make it easy for you to send out hundreds of emails quickly and easily from your email address. The follow information is needed to do this so, if you need help from you IT department, feel free to use <a id='itTemplateStatic'>this email template</a> or email <a href="mailto:{{ env('SUPPORT_EMAIL') }}">Mailsy Support</a> and we'd be happy to help.</p>
